                    ...
                    <div className={styles.detailsDiv}>
                      ...
                      <List>
                        ...
                        <ListItem className={styles.list}>
                          ...
                          <ListItemText primary={<Typography variant="h6" color="secondary">2014-120436</Typography>} />
                        </ListItem>

                        <ListItem className={styles.list}>
                          <Typography variant="h6" color="secondary" className={styles.listTitle}>College:</Typography>

                          <ListItemText primary={<Typography variant="h6" color="secondary">CICT</Typography>} />
                        </ListItem>

                        <ListItem className={styles.list}>
                          <Typography variant="h6" color="secondary" className={styles.listTitle}>Course:</Typography>
                          <ListItemText primary={<Typography variant="h6" color="secondary">BSIT</Typography>} />
                        </ListItem>

                        <ListItem className={styles.list}>
                          <Typography variant="h6" color="secondary" className={styles.listTitle}>Year/Section/Group:</Typography>
                          <ListItemText primary={<Typography variant="h6" color="secondary">3B-G1</Typography>} />
                        </ListItem>

                        <ListItem className={styles.list}>
                          <Typography variant="h6" color="secondary" className={styles.listTitle}>Email:</Typography>
                          <ListItemText primary={<Typography variant="h6" color="secondary">jeremiah@gmail.com</Typography>} />
                        </ListItem>

                        <ListItem className={styles.list}>
                          <Typography variant="h6" color="secondary" className={styles.listTitle}>Contact Number:</Typography>
                          <ListItemText primary={<Typography variant="h6" color="secondary">09163130373</Typography>} />
                        </ListItem>

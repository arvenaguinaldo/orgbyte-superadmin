...
import style from './EditOrganizationalShirt.scss';
...
class EditOrganizationalShirt extends Component {
  static propTypes = {
...
export default compose(
  reduxForm({
    form: 'EditOrgShirtForm',
    destroyOnUnmount: false,
    validate
  }),
  withStyles(styles)
)(EditOrganizationalShirt);
